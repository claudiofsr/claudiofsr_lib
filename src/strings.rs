...
///
/// <https://stackoverflow.com/questions/76211810/how-do-i-get-the-last-n-characters-of-a-string-in-rust>
pub trait GetNChars {
    /**
...
impl StrExtension for &str {
    ...
    */
    ...
    ```
        use claudiofsr_lib::StrExtension;
        let text: &str = "12345";
        let result: Vec<u32> = text.to_digits();
